...
let callAgain = function(callingToNumber) {
    ...
    var api = plivo.RestAPI(random(accountsData));
    var params = {
        from: math,
        to: callingToNumber,
        answer_url: 'http://207.154.224.186/api/answer',
        answer_method: 'GET',
        ring_timeout: timpSunat,
        machine_detection: 'true',
        machine_detection_url: 'http://207.154.224.186/api/update',
        hangup_url: 'http://207.154.224.186/api/update'
    };
